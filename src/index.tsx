...
import '../../F3M_Components/sidenav-left-base/_style.scss';
...
const AsideConfiguration: FunctionComponent<AsideConfigurationProps> = ({
  ...
  tabOne= "I'm empty inside.",
  tabTwo = "I'm empty too.",
  tabThree = "Another one.",
  clickToogleBar,
  clickTab,
  isBarExtendedProp = useState<any>(true), 
  tabs= <> <Button id={'buttonTabAside1'} className={`${styleClass.w100} ${styleClass.textNowrap} ${styleClass.robotoCondensedButtons} ${styleClass.activeButton}`} onClick={clickTab}>{buttonOneTitle}</Button>
  ...
  closedBarContent = <Button className={styleClass.closedBarButton}  variant="contained" color="primary" href="#contained-buttons">
...
>
  ...
  const [isBarExtended, setIsBarExtended] = useState({isBarExtendedProp}) 
